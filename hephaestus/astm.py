...
thermocouples = {
    ...
    "P": Thermocouple(
        Polynomial_Gaussian(
            ...
            invtable=None,
            calibration=_cal,
            source=_source + ", Table 3",
        ),
        ttype="Type P (II)",
    ),
    "AuFe 0.07": Thermocouple(
        Polynomial_Gaussian(
            table=[
                [
                    -273.0,
            ...
            invtable=None,
            calibration=_cal,
            source=_source + ", Table 5",
        ),
        ttype="Chromel-AuFe0.07",
    ),
    "PtMo 5-0.1": Thermocouple(
        Polynomial_Gaussian(
            table=[
                [
                    0.0,
            ...
            invtable=None,
            calibration=_cal,
            source=_source + ", Table 7",
        ),
        ttype="PtMo 5-0.1",
    ),
    "PtRh 40-20": Thermocouple(
        Polynomial_Gaussian(
            table=[
                [
                    0,
    ...
    "M": Thermocouple(
        Polynomial_Gaussian(
            ...
            invtable=None,
            calibration=_cal,
            source=_source + ", Table 11",
        ),
        ttype="Type M",
    ),
    "IrRh 40-0": Thermocouple(
        Polynomial_Gaussian(
            table=[
                [
                    0.0,
